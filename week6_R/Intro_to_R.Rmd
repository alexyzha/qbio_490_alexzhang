...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/week6_R")) 
```
...
f_factor <- factor(factor)
levels(f_factor) <- c("male","female")
...
age <- 10
birthday <- "01/02/2000"
three_fav_colors <- "red, green, blue"
...
ifelse(4 > 3, print("4>3"), print("4>/3")) # where x happens if the expression is true, and y happens if it is false

ifelse(3 > 4, print("3>4"), ifelse(4 > 3, print("4>3"), ifelse(4 > 5, print("4 > 5"), print("4 < 5"))))
```
...
```{r}
if (!require(ggplot2)){ # you only need to install a package once, this checks to see if it has already been installed
install.packages("ggplot2")
}

library(ggplot2) # you need to load in a package in every file that uses it (it's good practice to run all package related lines at the top of your file)
```

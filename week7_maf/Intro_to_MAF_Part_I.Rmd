...
write.csv(clinical, "/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/analysis_data/brca_clinical_data.csv", row.names = FALSE)
```
...
#also
# mut_pats_geneA <- length(unique(geneA_maf@clinical.data#Tumor_Sample_Barcode))
...
mosaicplot(contig)
#ggsave(PATH) for saving
ggasave("/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/week7_maf/mosaic_plot_AB.png")
```
...
ggsave("/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/week7_maf/oncoplot1.png")
```
...
ggsave("/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/week7_maf/co_oncoplot1")
```
...
#It is more highly mutated in younger patients.
Hypothesized Reason:
#As time goes on, the chances for the GATA3 gene to be mutated during DNA replication is increased, as more replications have occured.
...
#ggsave("PATH/TO/week7_maf/filename.png")
ggsave("/Users/aly/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/week7_maf/lollipop_plot1")
```
...
#the gene looks more commonly mutated in young patients
- Are there more mutations in a specific region of the protein? Why might that be?
#there are more mutations specifcally in the P53 region
- What kinds of mutations are the most common?
#it seems like missense mutations are the most common
- Are there any other interesting observations?
#the distribution between old and young is really close
...
#As days since last checkup increases, chance of survival decreases
What can you conclude from your plot?
#mutant and wild type versions of that gene follow similar trends
Is this what you would expect according to the literature? Why or why not?
#yes, as this might be bc of survivor bias. there will most likely be more people alive with lower times since last checkin as checking in would be a regular thing

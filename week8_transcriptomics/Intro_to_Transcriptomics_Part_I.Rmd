...
```{r Exercise 1.1}
# write code here
rna_sePRE <- load("~/Desktop/Main/School_Files/S2/QBIO/qbio_490_alexzhang/analysis_data/rna_se.RData") #loading data
rna_se <- as.data.frame(rna_sePRE) #loading data
...
```{r Exercise 2.3}
#write code here
rna_clinical <- rna_se@colData$age_at_index
...
```{r Exercise 2.5}
treatments_mask <- ifelse(colnames(rna_clinical) != "treatments", T, F)
...
```{r Exercise 4.2}
rna_counts <- rna_se@assays$unstranded[,!is.na(rna_se@colData$age_at_index)]
```
